...
st.image("Images/basic-emotions.jpg", use_container_width=True)
     #NEW below                               
...
st.write('---')
with col2:
    st.image("Images/thinkEmoji.jpg", use_container_width= True)
    #NEW below
    ...
    if 0 <= answer2 <=25:
        ...
        points += 48
    st.write('---')
st.image("Images/nav_weather.jpg", use_container_width=True)
    #NEW below
weather = st.radio(
...
if music == "Blues":
    ...
    points += 16
st.write('---')
st.image("Images/kitties.jpg", use_container_width=True)
    #NEW
...
if st.button("Complete Quiz"):
    if 1<=points<=25:
        st.image("Images/blue.jpg", use_container_width=True)
        st.subheader("**You're blue!**")
    elif 26<=points<=54:
        st.image("Images/indigo.jpg", use_container_width=True)
        st.subheader("**You're indigo!**")
    elif 55<=points<=83:
        st.image("Images/purple.jpg", use_container_width=True)
        st.subheader("**You're purple!**")
    elif 84<=points<=112:
        st.image("Images/green.jpg", use_container_width=True)
        st.subheader("**You're green!**")
    elif 113<=points<=141:
        st.image("Images/orange.jpg", use_container_width=True)
        st.subheader("**You're orange!**")
    elif 142<=points<=171:
        st.image("Images/red.jpg", use_container_width=True)
        st.subheader("**You're red!**")
    elif 172<=points:
        st.image("Images/yellow.jpg", use_container_width=True)
